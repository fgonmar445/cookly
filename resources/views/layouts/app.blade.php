            ...
            <div class="p-6 border-t border-slate-100 bg-slate-50/50">
                ...
                <div class="flex gap-2">
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="flex-1">
                        @csrf
                        <button type="submit" class="w-full flex items-center justify-center px-3 py-2 text-xs font-medium text-white bg-emerald-800 rounded-lg hover:bg-emerald-900 transition-all shadow-sm">
                            Salir
                        </button>
                    </form>
                </div>
