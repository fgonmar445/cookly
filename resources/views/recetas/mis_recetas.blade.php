...
<div class="max-w-6xl mx-auto">
    ...
    @if($recetas->isEmpty())
        <div class="text-center py-20 bg-white rounded-3xl border border-slate-100 shadow-sm">
            <div class="w-20 h-20 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-6 ring-8 ring-orange-50">
            ...
            <a href="{{ route('recetas.create') }}" class="text-orange-600 font-bold hover:underline">Crear mi primera receta</a>
        </div>
    @else
