...
<div class="flex justify-end">
    <a href="{{ url()->previous() }}"
        class="flex items-center gap-1 text-blue-600 hover:text-blue-800 mb-4">
...
<form action="{{ route('favoritos.toggle', $receta['idMeal']) }}" method="POST" class="mb-6">
    ...
    @else
    <button type="submit"
        class="inline-flex items-center justify-center bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-semibold">
        Añadir a favoritos
    </button>
    @endif
</form>
