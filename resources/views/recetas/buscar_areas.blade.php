...
<div class="mb-10">
    <h1 class="text-3xl font-black text-slate-800 mb-2 tracking-tight">Buscar por cocina</h1>
    <p class="text-slate-500">Descubre la gastronomía tradicional de diferentes regiones del mundo.</p>
</div>
